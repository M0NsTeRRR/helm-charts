...
```console
cosign verify ghcr.io/m0nsterrr/helm-charts/prowlarr:3.0.3 --certificate-identity=https://github.com/M0NsTeRRR/helm-charts/.github/workflows/releases.yml@refs/heads/main --certificate-oidc-issuer=https://token.ac
