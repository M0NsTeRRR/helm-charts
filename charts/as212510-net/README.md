...
```console
cosign verify ghcr.io/m0nsterrr/helm-charts/as212510-net:2.0.0 --certificate-identity=https://github.com/M0NsTeRRR/helm-charts/.github/workflows/releases.yml@refs/heads/main --certificate-oidc-issuer=https://token.ac
