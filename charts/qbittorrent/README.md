...
```console
cosign verify ghcr.io/m0nsterrr/helm-charts/qbittorrent:5.1.4 --certificate-identity-regexp=^https://github.com/M0NsTeRRR/helm-charts.*$ --certificate-oidc-issuer=https://token.ac
