...
```console
cosign verify ghcr.io/m0nsterrr/helm-charts/radarr:3.0.1 --certificate-identity=https://github.com/M0NsTeRRR/helm-charts/.github/workflows/releases.yml@refs/heads/main --certificate-oidc-issuer=https://token.ac
