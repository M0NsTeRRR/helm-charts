...
```console
cosign verify ghcr.io/m0nsterrr/helm-charts/homepage:4.5.0 --certificate-identity-regexp=^https://github.com/M0NsTeRRR/helm-charts.*$ --certificate-oidc-issuer=https://token.ac
