...
**Homepage:** <https://github.com/AS203038/looking-glass>
...
* <https://github.com/M0NsTeRRR/helm-charts/tree/main/charts/looking-glass>
...
```console
helm install looking-glass oci://ghcr.io/m0nsterrr/helm-charts/looking-glass
```
...
|-----|------|---------|-------------|
| affinity | object | `{}` |  |
| extraEnv | list | `[]` | Environment variables to add to the looking-glass pods |
| extraEnvFrom | list | `[]` | Environment variables from secrets or configmaps to add to the looking-glass pods |
