...
![Version: 2.3.0](https://img.shields.io/badge/Version-2.3.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 26.3.0](https://img.shields.io/badge/AppVersion-26.3.0-informational?style=flat-square)
...
```console
cosign verify ghcr.io/m0nsterrr/helm-charts/actualbudget:2.3.0 --certificate-identity-regexp=^https://github.com/M0NsTeRRR/helm-charts.*$ --certificate-oidc-issuer=https://token.ac
