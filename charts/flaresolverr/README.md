...
![Version: 2.0.3](https://img.shields.io/badge/Version-2.0.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v3.3.24](https://img.shields.io/badge/AppVersion-v3.3.24-informational?style=flat-square)
...
* <https://github.com/M0NsTeRRR/helm-charts/tree/main/charts/flaresolverr>
...
```console
cosign verify ghcr.io/m0nsterrr/helm-charts/flaresolverr:2.0.3 --certificate-identity=https://github.com/M0NsTeRRR/helm-charts/.github/workflows/releases.yml@refs/heads/main --certificate-oidc-issuer=https://token.ac
